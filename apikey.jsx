(function ymapsInit(e) {
                    ...
                    m.prototype = {
                        ...
                        _fulfill: function (e) {
                            this._status > h.RESOLVED ||
                                ((this._status = h.FULFILLED), (this._value = e), this._callCallbacks(this._fulfilledCallbacks, e), (this._fulfilledCallbacks = this._rejectedCallbacks = this._progressCallbacks = n));
                        },
                        _reject: function (e) {
...
})(
    {
        ...
        vectorVersionTimestamp: 1667048044577,
        flags: [],
        server: { url: "https://enterprise.api-maps.yandex.ru/2.1.79", path: "build/release", params: { apikey: "1220b4af-ae8e-4506-ab3a-c6329234066f", onload: "ymapsReady", mode: "release", ns: "ymaps", csp: null }, version: "2.1" },
        preload: { load: "package.full", bundle: "full", onLoad: "ymapsReady" },
        mode: "release",
        debug: false,
        namespace: "ymaps",
        enterprise: true,
        restrictions: { countries: ["AB", "AM", "AZ", "BY", "EE", "FR", "GE", "KG", "KZ", "LV", "MD", "OS", "RU", "TJ", "TM", "TR", "UA", "UZ"], prohibitedLayers: "sat", minZoom: 4, interactiveTraffic: false },
        apikey: "1220b4af-ae8e-4506-ab3a-c6329234066f",
        hasValidApiKey: true,
        browser: {
            name: "Chrome",
            version: "106.0.0.0",
        ...
        languageCode: "ru",
        countryCode: "RU",
        yandexMapDisableAdverts: true,
        theme: null,
        dataProvider: null,
        dataPrestable: false,
        hosts: {
            api: {
                main: "https://enterprise.api-maps.yandex.ru/",
                ua: "https://yandex.ru/legal/maps_termsofuse/?lang={{lang}}",
                maps: "https://yandex.ru/maps/",
                statCounter: "https://yandex.ru/clck/",
                services: {
                    coverage: "https://enterprise.api-maps.yandex.ru/services/coverage/",
                    geocode: "https://geocode-maps.yandex.ru/",
                    geoxml: "https://enterprise.api-maps.yandex.ru/services/geoxml/",
                    inception: "https://api-maps.yandex.ru/services/inception/",
                    panoramaLocate: "https://enterprise.api-maps.yandex.ru/services/panoramas/",
                    search: "https://enterprise.api-maps.yandex.ru/services/search/",
                    suggest: "https://suggest-maps.yandex.ru/",
                    regions: "https://enterprise.api-maps.yandex.ru/services/regions/",
                    route: "https://enterprise.api-maps.yandex.ru/services/route/",
        ...
        layers: {
            map: { version: "22.10.27-0-b220930144100", scaled: true, hotspotZoomRange: [1, 23], hotspotExcludeByTags: ["admin"] },
            skl: { version: "22.10.27-0-b220930144100", scaled: true, hotspotZoomRange: [1, 23], hotspotExcludeByTags: ["admin"] },
            sat: { version: "3.1032.0" },
            stv: { version: "2022.10.28.19.51-1_22.10.28-0-12778" },
            sta: { version: "2022.10.28.19.51-1_22.10.28-0-12778" },
            trf: { version: "1667047920", scaled: true },
            trfe: { version: "", scaled: true, hotspotZoomRange: [0, 21] },
            carparks: { version: "", scaled: true },
        },
        geolocation: { longitude: 7.470372, latitude: 51.523549, isHighAccuracy: false, span: { longitude: 0.326088, latitude: 0.13654 } },
        token: "12fa4196d190cd2b9dad5d3b120f9333",
        distribution: {},
        version: "2.1.79",
        majorVersion: "2.1",
        ...
        bundles: { panoramas: "/release/panoramas-67f02cdbd424948058b32e826ab1c40c341fed38.js", full: "/release/full-12d3b6ea37df4ec19ca51b92a0651e126f59c33e.js", PREFIX: "s3/front-maps-static/maps-front-jsapi-v2-1/2.1.79-43/build" },
    },
    null
);
